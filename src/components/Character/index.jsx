...
const Character = ({ match, firebase }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      firebase.character(match.params.characterId).off();
    };
        ...
        <Grid container>
          <Grid.Column width={12}>
            <Grid>
              <Grid.Column width={6}>
                <Card>
                  <Image src={character.pictureUrl} fluid />
                  <Card.Content>
                    <Card.Header>
              ...
              <Grid.Column width={4}>
                <Card>
                  <Card.Content>
                    ...
                    <Card.Description>Items: Wealth:</Card.Description>
                  </Card.Content>
                </Card>
              </Grid.Column>
              <Grid.Column width={6}>
                  ...
                  <List divided size="large">
                    {map(character.inventory, (item, key) => (
                      <List.Item key={key}>
                        ...
                        <List.Content>{item.type}</List.Content>
                      </List.Item>
                    ))}
                  </List>
                </Card.Description>
